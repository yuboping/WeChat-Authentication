...
String replyMsg = MessageUtil.getMessage(eccode+"_"+WXAuthContant.MSG_FUNCNAME_WX_WIFI,WXAuthContant.MSG_FUNCNAME_WX_WIFI,
...
<div class="top"><img src="images/top.jpg" alt=""/></div>
 <div class="main">
  <div class="main_lt"><img src="images/wx.jpg" alt=""/></div>
  <div class="main_rt">长按二维码<p>进入公众号</p></div>
</div>
</body>
</html>
